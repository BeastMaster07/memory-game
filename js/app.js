var card, cardCount, moves, moveText, moveCount, movesTaken, timeTaken, stars, card_1, ul, cardOpenCount, flag, afterText, playAgain_yes, playAgain_no, afterText_moves, afterText_playAgain, timer, flag_timer, sec, min, hrs, t, storage;
...
function cardOpen(index) {   
  if(!(index.classList.contains('open'))) {
    ...
    if(cardCount == 0) {
        ...
        // storage.push(localStorage.getItem('moves'));
        // console.log(storage);
        clearInterval(t);
        setTimeout(function () {
